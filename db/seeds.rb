...
pin = Pin.create!(name: "Hungry Heaven", address: "〒153-0064 Tokyo, Meguro City, Shimomeguro, 1 Chome−2−22 セザール目黒 2F", latitude: 35.63409123108172, longitude: 139.71368136084774, comments: "Good burger", icon: "", rating: 4, visited: true, private: false, user: user)
...
pin = Pin.create!(name: "LAND", address: "〒153-0064 Tokyo, Meguro City, Shimomeguro, 2 Chome−21−28 セントヒルズ目黒 2F", latitude: 35.633201465597644, longitude: 139.7093625975676, comments: "Good curry", icon: "", rating: 4.3, visited: false, private: true, user: user)
...
pin = Pin.create!(name: "JACK Meguro", address: "1 Chome-3-28 Shimomeguro, Meguro City, Tokyo 153-0064", latitude: 35.634379078062274, longitude: 139.71305695766375, comments: "Dartbar", icon: "", rating: 3, visited: false, private: false, user: user)
...
pin = Pin.create!(name: "Sukiya", address: "3 Chome-9-3 Meguro, Meguro City, Tokyo 153-0063", latitude: 35.63297712068992, longitude: 139.7078577134912, comments: "Beef bowls", icon: "", rating: 3.5, visited: true, private: true, user: user)
...
pin = Pin.create!(name: "Go Bring Slider SANDWICH HOUSE", address: "2 Chome-11-9 Meguro, Meguro City, Tokyo 153-0063", latitude: 35.63371719923141, longitude: 139.7080349, comments: "Good sliders", icon: "", rating: 4.2, visited: false, private: true, user: user)
...
pin = Pin.create!(name: "Pizza Giardino Savoy", address: "〒153-0064 Tokyo, Meguro City, Shimomeguro, 2 Chome−2−16 第６千陽ビル 101", latitude: 35.632202361865986, longitude: 139.71087045767248, comments: "Good pizza", icon: "", rating: 3.6, visited: true, private: false, user: user)
...
pin = Pin.create!(name: "Wagaya", address: "2 Chome-2-8 Shimomeguro, Meguro City, Tokyo 153-0064", latitude: 35.63203090245075, longitude: 139.71130711534505, comments: "Korean food", icon: "", rating: 4.5, visited: false, private: true, user: user)
...
pin = Pin.create!(name: "Tonkatsu Taihou", address: "1 Chome-6-15 Meguro, Meguro City, Tokyo 153-0063", latitude: 35.63451281885251, longitude: 139.71174804232749, comments: "Tonkatsu", icon: "", rating: 3.4, visited: false, private: false, user: user)
...
pin = Pin.create!(name: "Bangkok Oriental Thai Restaurant", address: "1 Chome-3-1 Shimomeguro, Meguro City, Tokyo 153-0064", latitude: 35.63444597738727, longitude: 139.71333583069008, comments: "Thai food", icon: "", rating: 4, visited: true, private: false, user: user)
...
pin = Pin.create!(name: "I-rottah", address: "1 Chome-5-21 Shimomeguro, Meguro City, Tokyo 153-0064", latitude: 35.6344643176884, longitude: 139.71243018650878, comments: "Italian restaurant", icon: "", rating: 3, visited: true, private: false, user: user)
...
pin = Pin.create!(name: "Shokumusō", address: "1 Chome-6-12 Meguro, Meguro City, Tokyo 153-0063", latitude: 35.63473299729209, longitude: 139.7121311, comments: "Chinese restaurant", icon: "", rating: 4.5, visited: true, private: false, user: user)
...
pin = Pin.create!(name: "Chuka Soba Takemura", address: "1 Chome-6-14 Meguro, Meguro City, Tokyo 153-0063", latitude: 35.63459191809312, longitude: 139.71181339999998, comments: "Ramen", icon: "", rating: 2.2, visited: false, private: true, user: user)
...
pin = Pin.create!(name: "Torikizoku Meguro Nishiguchi", address: "〒153-0064 Tokyo, Meguro City, Shimomeguro, 1 Chome−1−2 七幸ビル ４階", latitude: 35.63389327868364, longitude: 139.71419472883625, comments: "Izakaya", icon: "", rating: 3.8, visited: true, private: false, user: user)
...
pin = Pin.create!(name: "Midori", address: "2 Chome-13-41 Kamiosaki, Shinagawa City, Tokyo 141-0021", latitude: 35.63454305728192, longitude: 139.71719530185385, comments: "Izakaya", icon: "", rating: 4, visited: true, private: false, user: user)
